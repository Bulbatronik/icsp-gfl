...
DATASETS=("cifar10_iid" "cifar10_niid")
CLIENT_CONFIGS=("random" "spect_eig3_cos" "heatkernel")
SEEDS=("42" "43" "44")
...
for seed in "${SEEDS[@]}"; do
    ...
    for dataset in "${DATASETS[@]}"; do
        for client_config in "${CLIENT_CONFIGS[@]}"; do
            ...
            python3 main.py dataset=$dataset client=$client_config training=cifar10cnn seed=$seed network=ranom10 client.num_eig=4 client.t=40
